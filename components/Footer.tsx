        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Explore the latest trends and unique fashion styles with Chitan
              Store — Where elegance meets creativity!
            </p>
            <SocialMedia
          ...
          <div>
            <h3 className="font-semibold text-darkColor-900 mb-4">
              Newsletter
            </h3>
            <p className="text-gray-600 text-sm mb-4">
              Subscribe to our newsletter to receive update and exclusive
              offers.
            </p>
