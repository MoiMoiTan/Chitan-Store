    ...
    <Container className="max-w-3xl sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-4">
        <section>
          ...
          <p>
            We collect information you provide directly to us when uing our
            services, as well as information about you use of out services.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            We do not share your personal information with third parties expect
        ...
        <section>
          ...
          <p>
            We take resonable measures to help protect your personal information
