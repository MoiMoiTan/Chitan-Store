              ...
              <div className="grid lg:grid-cols-3 md:gap-8">
                  ...
                  <div className="border bg-white rounded-md">
                    {cartProducts?.map(({ product }) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex flex-1 items-center gap-2 h-3/6 md:h-44">
                            {product?.images && (
                              <Link
                              ...
                              >
                                <Image
                                  ...
                                  height={500}
                                  loading="lazy"
                                  className="w-32 md:w-40 h32 md:h-40 object-cover group-hover:scale-105 overflow-hidden hoverEffect"
                                />
                              </Link>
                            )}
                ...
                <div className="lg:col-span-1">
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    <h2 className="text-xl font-semibold p-4">Order Summary</h2>
                    <div className="space-y-4">
                      ...
                      <Link
                        href={"/"}
                        className="flex
                       items-center justify-center py-2 border border-darkColor/50 rounded-full hover:border-darkColor/5 hoverEffect"
                      >
                        <Image
                          src={paypalLogo}
                          alt="paypalLogo"
